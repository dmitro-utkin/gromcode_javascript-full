...
const successPromise = new Promise(resolve => {
  /* ...code here */
  resolve(67); // successPromise - це об'єкт Promise
});
...
successPromise.then(function onSuccess(number) {
  /* ...code here */
  console.log(number * number); // виводимо в консоль квадрат числа
});
...
successPromise.catch(function onError() {
  /* ...code here */
  console.log('I am an error'); // текст не виведеться в консоль, оскільки проміс успішно виконався
});